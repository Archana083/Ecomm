  ...
  return (
    <div className="container my-5">
      <div className="row parent-quality-card">
        <div className="col-xl-3 col-sm-6 col-xs-12 py-2 d-flex  justify-content-center gap-3 align-items-center quality-card">
        ...
        <div className="col-xl-3 col-sm-6 py-2 d-flex justify-content-center gap-3 align-items-center quality-card">
          <div className="img-quality">
        ...
        <div className="col-xl-3 col-sm-6  d-flex justify-content-center gap-3 align-items-center quality-card">
          <div className="img-quality">
